...
namespace Task
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Computer(){Id = "A01", NameMark = "Intel", TypeProcessor = "i3", Frequency = 3.2, RAM = 4, VHardDisk = 5000, VRAM = 8, CostComputer = 55000, Quantity = 3},
                new Computer(){Id = "A02", NameMark = "AMD", TypeProcessor = "ryazan 7", Frequency = 3.9, RAM = 8, VHardDisk = 1000, VRAM = 12, CostComputer = 75000, Quantity = 73},
                new Computer(){Id = "A03", NameMark = "Intel", TypeProcessor = "i5", Frequency = 3.8, RAM = 8, VHardDisk = 750, VRAM = 16, CostComputer = 70000, Quantity = 29},
